...
import com.alura.java.forumhub.dto.CursoDto;
import com.alura.java.forumhub.model.Curso;
import com.alura.java.forumhub.service.CursoService;
...
public class CursoController {
    ...
    @PostMapping
    public ResponseEntity<Object> salvarCurso(@RequestBody @Valid CursoDto cursoRecordDto, UriComponentsBuilder uriComponentsBuilder) {
